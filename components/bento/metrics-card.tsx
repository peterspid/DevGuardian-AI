  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 flex flex-col justify-center gap-6 p-6">
        <ScrambleNumber target="6" label="Agents" delay={500} />
        <ScrambleNumber target="12" label="Protected actions" delay={800} />
        <ScrambleNumber target="99.9%" label="Audit coverage" delay={1100} />
        <ScrambleNumber target="40ms" label="Policy check" delay={1400} />
      </div>
    </div>
  )
}
