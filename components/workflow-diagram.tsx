...
const LEFT_LABELS = ["Plan", "Code", "Secure"]
const RIGHT_LABELS = ["Test", "Review", "Deploy"]
  ...
  return (
    <div className="relative w-full max-w-[800px] mx-auto">
      <svg
        ...
        role="img"
        aria-label="Workflow diagram showing connected DevGuardian stages: Plan, Code, Secure, Test, Review, Deploy"
      >
