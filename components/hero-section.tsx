  ...
  return (
    <section className="relative w-full px-12 pt-6 pb-12 lg:px-24 lg:pt-10 lg:pb-16">
      <div className="flex flex-col items-center text-center">
        ...
        >
          A trusted multi-agent software engineer with Terminal3 identity, scoped agent permissions, signed protected actions, and production audit logs.
        </motion.p>
        ...
        <motion.div
          ...
          whileTap={{ scale: 0.97 }}
        >
          <Link href="/chat" className="group flex items-center gap-0 bg-foreground text-background text-sm font-mono tracking-wider uppercase">
