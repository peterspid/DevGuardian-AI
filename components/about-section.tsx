...
const STATS = [
  ...
  { label: "AUDIT_EVENTS", value: "∞" },
  { label: "DEPLOY_GATES", value: "2" },
]
    ...
    <section className="w-full px-6 py-20 lg:px-12">
      ...
      <div className="flex flex-col lg:flex-row gap-0 border-2 border-foreground">
        ...
        <motion.div
          ...
          className="relative w-full lg:w-1/2 min-h-[300px] lg:min-h-[500px] border-b-2 lg:border-b-0 lg:border-r-2 border-foreground overflow-hidden bg-foreground bg-[url('/images/about-isometric.jpg')] bg-cover bg-center"
        >
          {/* Image label overlay */}
          ...
          <Image
            ...
            alt="Isometric view of trusted AI agent infrastructure with server racks and data pipelines"
            fill
        ...
        >
          ...
          <div className="flex-1 flex flex-col justify-between px-5 py-6 lg:py-8">
            <div className="flex flex-col gap-6">
              ...
              >
                Software agents built for
                <br />
                <span className="text-[#ea580c]">verifiable work</span>
              </motion.h2>
              ...
              >
                <p className="text-xs lg:text-sm font-mono text-muted-foreground leading-relaxed">
                  DevGuardian AI turns a feature request into a traceable engineering run:
                  planning, code changes, security review, tests, human approval, and
                  deployment are split across scoped agents instead of one unbounded bot.
                </p>
                <p className="text-xs lg:text-sm font-mono text-muted-foreground leading-relaxed">
                  Terminal3 Agent Auth SDK sits in the trust path. Agents request
                  purpose-specific permissions, protected actions are signed, and every
                  release decision leaves audit evidence that a reviewer can inspect.
                </p>
              </motion.div>
